...
func GetAllContainerVersions(connectionsList []connections.Connection, cwctlVersion string, httpClient utils.HTTPClient, dockerClient utils.DockerClient) (ContainerVersionsList, error) {
